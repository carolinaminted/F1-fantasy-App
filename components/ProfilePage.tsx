...
import { updateUserProfile, getPublicProfileRank } from '../services/firestoreService.ts';
...
const ProfilePage: React.FC<ProfilePageProps> = ({ 
  ...
  // Championship rank is league-wide ordering authored by the
  // recalculateEntireLeague Cloud Function. It is NOT computed client-side.
  useEffect(() => {
      let cancelled = false;
      (async () => {
