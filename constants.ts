...
export const EVENTS: Event[] = [
    { id: 'aus_26', round: 1, name: 'Australian GP', country: 'Australia', location: 'Melbourne', circuit: 'Albert Park Circuit', hasSprint: false, ...createEventDate('2026-03-08') },
    { id: 'chn_26', round: 2, name: 'Chinese GP', country: 'China', location: 'Shanghai', circuit: 'Shanghai International Circuit', hasSprint: true, ...createEventDate('2026-03-15') },
    { id: 'jpn_26', round: 3, name: 'Japanese GP', country: 'Japan', location: 'Suzuka', circuit: 'Suzuka International Racing Course', hasSprint: false, ...createEventDate('2026-03-29') },
    { id: 'bhr_26', round: 4, name: 'Bahrain GP', country: 'Bahrain', location: 'Sakhir', circuit: 'Bahrain International Circuit', hasSprint: false, ...createEventDate('2026-04-12') },
    { id: 'sau_26', round: 5, name: 'Saudi Arabian GP', country: 'Saudi Arabia', location: 'Jeddah', circuit: 'Jeddah Corniche Circuit', hasSprint: false, ...createEventDate('2026-04-19') },
    { id: 'mia_26', round: 6, name: 'Miami GP', country: 'USA', location: 'Miami', circuit: 'Miami International Autodrome', hasSprint: true, ...createEventDate('2026-05-03') },
    { id: 'can_26', round: 7, name: 'Canadian GP', country: 'Canada', location: 'Montreal', circuit: 'Circuit Gilles-Villeneuve', hasSprint: true, ...createEventDate('2026-05-24') },
    { id: 'mco_26', round: 8, name: 'Monaco GP', country: 'Monaco', location: 'Monaco', circuit: 'Circuit de Monaco', hasSprint: false, ...createEventDate('2026-06-07') },
    { id: 'esp_26', round: 9, name: 'Spanish GP', country: 'Spain', location: 'Barcelona-Catalunya', circuit: 'Circuit de Barcelona-Catalunya', hasSprint: false, ...createEventDate('2026-06-14') },
    { id: 'aut_26', round: 10, name: 'Austrian GP', country: 'Austria', location: 'Spielberg', circuit: 'Red Bull Ring', hasSprint: false, ...createEventDate('2026-06-28') },
    { id: 'gbr_26', round: 11, name: 'British GP', country: 'Great Britain', location: 'Silverstone', circuit: 'Silverstone Circuit', hasSprint: true, ...createEventDate('2026-07-05') },
    { id: 'bel_26', round: 12, name: 'Belgian GP', country: 'Belgium', location: 'Spa-Francorchamps', circuit: 'Circuit de Spa-Francorchamps', hasSprint: false, ...createEventDate('2026-07-19') },
    { id: 'hun_26', round: 13, name: 'Hungarian GP', country: 'Hungary', location: 'Budapest', circuit: 'Hungaroring', hasSprint: false, ...createEventDate('2026-07-26') },
    { id: 'nld_26', round: 14, name: 'Dutch GP', country: 'Netherlands', location: 'Zandvoort', circuit: 'Circuit Zandvoort', hasSprint: true, ...createEventDate('2026-08-23') },
    { id: 'ita_26', round: 15, name: 'Italian GP', country: 'Italy', location: 'Monza', circuit: 'Autodromo Nazionale Monza', hasSprint: false, ...createEventDate('2026-09-06') },
    { id: 'mad_26', round: 16, name: 'Madrid GP', country: 'Spain', location: 'Madrid (New Circuit)', circuit: 'IFEMA Madrid Circuit', hasSprint: false, ...createEventDate('2026-09-13') },
    { id: 'aze_26', round: 17, name: 'Azerbaijan GP', country: 'Azerbaijan', location: 'Baku', circuit: 'Baku City Circuit', hasSprint: false, ...createEventDate('2026-09-26') },
    { id: 'sgp_26', round: 18, name: 'Singapore GP', country: 'Singapore', location: 'Marina Bay', circuit: 'Marina Bay Street Circuit', hasSprint: true, ...createEventDate('2026-10-11') },
    { id: 'usa_26', round: 19, name: 'United States GP', country: 'USA', location: 'Austin (COTA)', circuit: 'Circuit of the Americas', hasSprint: false, ...createEventDate('2026-10-25') },
    { id: 'mex_26', round: 20, name: 'Mexico City GP', country: 'Mexico', location: 'Mexico City', circuit: 'Autódromo Hermanos Rodríguez', hasSprint: false, ...createEventDate('2026-11-01') },
    { id: 'bra_26', round: 21, name: 'Sao Paulo GP', country: 'Brazil', location: 'Interlagos', circuit: 'Autódromo de Interlagos', hasSprint: false, ...createEventDate('2026-11-08') },
    { id: 'las_26', round: 22, name: 'Las Vegas GP', country: 'USA', location: 'Las Vegas', circuit: 'Las Vegas Strip Circuit', hasSprint: false, ...createEventDate('2026-11-21') },
    { id: 'qat_26', round: 23, name: 'Qatar GP', country: 'Qatar', location: 'Lusail', circuit: 'Lusail International Circuit', hasSprint: false, ...createEventDate('2026-11-29') },
    { id: 'abu_26', round: 24, name: 'Abu Dhabi GP', country: 'Abu Dhabi', location: 'Yas Marina', circuit: 'Yas Marina Circuit', hasSprint: false, ...createEventDate('2026-12-06') },
];
